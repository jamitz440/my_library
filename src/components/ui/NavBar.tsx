...
const ProfileButton = ({ selected }: { selected: boolean }) => {
  return (
    <div
      className={`${selected ? "block rounded bg-blue-700 px-3 py-2 text-white dark:text-white sm:bg-transparent sm:p-0 sm:text-primary sm:dark:text-primary" : "block rounded px-3 py-2 text-muted-foreground hover:bg-gray-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white sm:border-0 sm:p-0 sm:hover:bg-transparent sm:hover:text-primary sm:dark:hover:bg-transparent sm:dark:hover:text-primary"}`}
    >
      <SignedIn>
